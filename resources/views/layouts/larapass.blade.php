...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased  bg-gray-50">
        ...
        <header class="sticky top-0 inset-x-0 flex flex-wrap sm:justify-start sm:flex-nowrap z-[48] w-full bg-white border-b text-sm py-2.5 sm:py-4 lg:ps-64 dark:bg-neutral-800 dark:border-neutral-700">
            <nav class="flex basis-full items-center w-full mx-auto px-4 sm:px-6" aria-label="Global">
                <div class="me-5 lg:me-0 lg:hidden">
                    <!-- Logo -->
                    <a class="flex-none rounded-xl text-xl inline-block font-semibold focus:outline-none focus:opacity-80" href="{{route('dashboard')}}" aria-label="LaraPass">
                        LaraPass
                    </a>
                    <!-- End Logo -->
                </div>
     ...
     ">
            <div class="px-8 pt-4">
                <!-- Logo -->
                <a class="flex-none rounded-xl text-2xl inline-block font-logo font-bold text-gradient focus:outline-none focus:opacity-80" href="{{route('dashboard')}}" aria-label="LaraPass">
                    LaraPass
                </a>
                <!-- End Logo -->
            </div>
            ...
            <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
                <ul class="space-y-1.5">
                    <li>
                        <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-md text-white rounded-lg hover:bg-gradient-lp" href="#">
