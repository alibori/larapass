...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased  bg-gray-50">
      ...
      bg-slate-900 border-e border-gray-200
      lg:block lg:translate-x-0 lg:end-auto lg:bottom-0
     ">
            <div class="px-8 pt-4">
                <!-- Logo -->
                <a class="flex-none rounded-xl text-2xl inline-block font-logo font-bold text-gradient focus:outline-none focus:opacity-80" href="{{route('dashboard')}}" wire:navigate aria-label="LaraPass">
                    LaraPass
                </a>
                <!-- End Logo -->
            </div>
